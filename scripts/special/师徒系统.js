    ...
    if (status == 0) {
        ...
        if (selection == 0) {//建立师门
            ...
            for (var i = 0; i < 出师奖励.length; i++) {
                text += "			#d#d点券#k x #b1000#k #d抵用券#k x #b2000#k\r\n";
            }
            text += "	#e#d┗━━━━━━━━━━ ━━━━━━━━━━┛#n#k\r\n"
            cm.sendSimple(text);
            cm.dispose();
