...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "\t" + 红色箭头 + " #v5200002# 100万 金币 \r\n";
            txt += "\t" + 红色箭头 + " #v5220010##z5220010# 5 张  \r\n";
            txt += "\t" + 红色箭头 + " #v5150040##z5150040# 2 张  \r\n";
            txt += "\t" + 红色箭头 + " #v5211047##z5211047# 1 张  \r\n";
            txt += "\t" + 红色箭头 + " #v2049401##z2049401# 10 张  \r\n";
            txt += "\t" + 红色箭头 + " #v2001512##z2001512# 300 个 \r\n";
            txt += " #r#e请输入：【#rPPMS#k】   获取新手礼包奖励！！#k#n\r\n\r\n"
            cm.sendGetText(txt);
        } else if (status == 1) {
            if (cm.getText() == "PPMS") {
                var next = true;
                ...
                cm.gainItem(2001512, 300);
                cm.sendOk("恭喜你领取成功！！！");
                cm.worldMessage(6, "欢迎" + cm.getPlayer().getName() + "来到PPMS怀旧服，要收徒弟的赶紧了！");
                cm.dispose();
            } else {
