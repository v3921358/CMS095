...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var text = "";
            for (i = 0; i < 10; i++) {
                text += "您好在我这里可以用#b点券购物#k\r\n\r\n";
				text += "" + 蓝色箭头 + "#L2##b#v5064000#*1#k 兑换#r 4900点券#k#l \r\n\r\n";
                text += "" + 蓝色箭头 + "#L3##b#v5064000#*10#k 兑换#r 49000点券#k#l \r\n\r\n";
              //  text += "" + 蓝色箭头 + "#L4##b#v4001126#*500#k 兑换#r 5W点券#k#l \r\n\r\n";      
              //  text += "" + 蓝色箭头 + "#L5##b#v4001126#*1000#k 兑换#r 10W点券#k#l \r\n\r\n";
			  //  text += "" + 蓝色箭头 + "#L6##b#v4001126#*3000#k 兑换#r 30W点券#k#l \r\n\r\n";
			//	text += "" + 蓝色箭头 + "#L7##b#v4001126#*10000#k 兑换#r 100W点券#k#l \r\n\r\n";
			...
			if (cm.getPlayer().getCSPoints(1) >= 4900) {
                
               
				cm.gainNX(-4900);
				cm.gainItem(5064000, 1);//扣除点券数量
				 cm.sendOk("换购成功！");
				 cm.worldMessage(5, "恭喜" + cm.getPlayer().getName() + "成功购买防爆卷X1！");
                cm.dispose();//结束
            } else {
                cm.sendOk("点券不足无法换购！");
                cm.dispose();
			...
			if (cm.getPlayer().getCSPoints(1) >= 49000) {
                
               
				cm.gainNX(-49000);
				cm.gainItem(5064000, 10);//扣除点券数量
				 cm.sendOk("换购成功！");
				 cm.worldMessage(5, "恭喜" + cm.getPlayer().getName() + "成功购买防爆卷X10！");
                cm.dispose();//结束
            } else {
                cm.sendOk("点券不足无法换购！");
                cm.dispose();
