//怪物id
var moblistid = [8900000, 8910000, 8920000, 8930000];
//怪物血量
var mobhp = 6000000000;
//怪物等级
var moblevel = 200;
//开始副本的所在地图
var startmap = 105200410;
//时间到之后退出的地图
...
function setup(eim, leaderid) {
    ...
    for (var i = 0; i < moblistid.length; i++) {
        var mob = em.getMonster(moblistid[i]); //召唤怪物
...
function checkHP(eim) {
    ...
    for (var i = 0; i < mobs.size(); i++) {
        ...
        mobhpMSG += getBossName(mobs.get(i).getId()) + Math.floor((mobs.get(i).getHp() / mobhp) * 100) + "%、";
    }
