...
function setup(partyid) {
    ...
    map.toggleDrops();
    map.spawnNpc(2060103, new java.awt.Point(-780, -557));
...
function monsterSpawn(eim) { // Custom function
	...
	case 9500392: // Rombot
	    var modified = em.newMonsterStats();
	    modified.setOExp(mob.getMobExp() * 18);
	    modified.setOHp(mob.getMobMaxHp() * 8);
	    modified.setOMp(mob.getMobMaxMp() * 8);
	...
	case 8500001: // Papulatus
	    var modified = em.newMonsterStats();
	    modified.setOExp(mob.getMobExp() * 3); //2nd body gives exp as well
	    modified.setOHp(mob.getMobMaxHp() * 8);
	    modified.setOMp(mob.getMobMaxMp() * 1.5);
...
function allMonstersDead(eim) {
	...
	eim.saveBossQuest(-185);
	eim.broadcastPlayerMsg(5, "Your team've beaten the MED mode! Congratulations!");
    }
