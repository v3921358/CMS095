...
function setup() {
    ...
    var map = eim.setInstanceMap(749060605);
    map.resetFully();
    var mob = em.getMonster(9410089);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-135, 302));
    eim.startEventTimer(1200000); //20 分
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(749060605);
