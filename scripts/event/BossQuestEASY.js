...
function setup(partyid) {
    ...
    map.toggleDrops();
    map.spawnNpc(2060103, new java.awt.Point(37, -855));
...
function allMonstersDead(eim) {
    ...
    eim.broadcastPlayerMsg(5, "你的队伍赢得了"+num+" Boss点数!总共 "+totalp+".");

    eim.saveBossQuest(num);

    if (mobnum < monster.length) {
	eim.broadcastPlayerMsg(6, "准备！下一个Boss马上就会出现！");
} else {
	eim.saveBossQuest(320);
	//eim.saveNX(200);
	eim.broadcastPlayerMsg(5, "您的团队已经击败了简单模式，将获得总共1000个Boss点数和200点券的奖励！");
    }
