...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("您好，我是#r #p9250049##k 欢迎來到黃金寺廟的美髮廳 如果您有\r\n#b#t5150042##k, 或者 #b#t5151032##k 我就可以免費帮您弄 \r\n#L0##b使用#t5150042##k#l \r\n#L1##b使用#t5151032##k#l");
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendStyle("選擇一个喜欢的", haircolor);
            }
        } else if (status == 2) {
            if (beauty == 1) {
