...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	cm.sendSimple("嗨，我是#p2041009# 如果你有 #b#t5150012##k 或 #b#t5151006##k 我就可以帮你改变 请選擇要哪种服務: \r\n#L0#使用: #i5150006##t5150006##l\r\n#L1#使用: #i5151006##t5151006##l");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.sendYesNo("是否确定要使用注意:他是#r隨機#k!");
	} else if (selection == 1) {
	...
	if (beauty == 1){
		...
		cm.sendOk("痾..貌似沒有#t5150006#");
	    }
	} else {
	    if (cm.setRandomAvatar(5151006, hair_Colo_new) == 1) {
		cm.sendOk("享受!");
	    } else {
		cm.sendOk("痾..貌似沒有#t5151006#");
	    }
	}
	cm.dispose();
    }
