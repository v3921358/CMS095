...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        if (selectedType == 0) { //warrior shoes
            selStr = "需要什么吗？？#b";
            var shoes = new Array("#t1072147##k - 剑士 等級. 60#b", "#t1072148##k - 剑士 等級. 60#b", "#t1072149##k - 剑士 等級. 60#b",
                    "#t1072154##k - 剑士 等級. 70#b", "#t1072155##k - 剑士 等級. 70#b", "#t1072156##k - 剑士 等級. 70#b",
                    "#t1072210##k - 剑士 等級. 80#b", "#t1072211##k - 剑士 等級. 80#b", "#t1072212##k - 剑士 等級. 80#b");
            ...
            selStr = "需要什么吗？？#b";
            var shoes = new Array("#t1072136##k - 法师 等級. 60#b", "#t1072137##k - 法师 等級. 60#b", "#t1072138##k - 法师 等級. 60#b", "#t1072139##k - 法师 等級. 60#b",
                    "#t1072157##k - 法师 等級. 70#b", "#t1072158##k - 法师 等級. 70#b", "#t1072159##k - 法师 等級. 70#b", "#t1072160##k - 法师 等級. 70#b",
                    "#t1072177##k - 法师 等級. 80#b", "#t1072178##k - 法师 等級. 80#b", "#t1072179##k - 法师 等級. 80#b");
        ...
        var prompt = "你想要做一双 #t" + item + "#? 在这种情況下, 我为了要做出最棒的品质，我建议你确保裝备栏空间足够。#b";
