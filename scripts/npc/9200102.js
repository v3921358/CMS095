...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            beauty = 2;
            cm.askAvatar("With our new computer program, you can see yourself after the treatment in advance. What kind of lens would you like to wear? Please choose the style of your liking.", 5152015, hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {
