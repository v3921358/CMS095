...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.sendSimple("Hello! I'm the #r#eHairstyle NPC#n#k. My life is all about vote points. I see you have #e#r" + cm.getPlayer().getVPoints() + "#n#k voting points! I can redeem your points for one of my hairstyles! What would you like...?\r\n\r\n#b#L2#Trade for Royal Hair#r 10 Vote Points #k#l\r\n");
    } else if (status == 1) {
        status += selection;
        var selStr;
        var it;
