...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var options = new Array("制作矿石", "提炼寶石矿", "鋼鐵肥肥的腿兌換中心...", "升級拳套");
        ...
        if (selectedType == 0) { //mineral refine
            ...
            var selStr = "所以你要我提炼哪种寶石??#b";
            var jewels = new Array("石榴石", "紫水晶", "海藍寶石", "祖母绿", "蛋白石", "藍寶石", "黃晶", "鑽石", "黑暗水晶");
            ...
            var selStr = "你知道吗？很多人不知道，在鐵豬的蹄金屬的潛力......我可以使它成为一些特別的東西，如果你要我做的话...";
            equip = false;
            cm.sendYesNo(selStr);
        } else if (selectedType == 3) { //claw refine
            var selStr = "啊你想要升級拳套，告訴我要升級哪一个?\r\n#e#r(这边有小BUG例如你選错你要升級的拳套)\r\n(请勿停止对话OR取消因为会斷線这點请特別注意!)\r\n(所以请先選好您要升級的拳套)#k#n#b";
            var claws = new Array("赤紅战神拳套#k - 盜賊 等級. 60#b", "藍寶战神拳套#k - 盜賊 等級. 60#b", "黑战神拳套#k - 盜賊 等級. 60#b");
        ...
        var prompt = "所以，你要我做一些 #t" + item + "#? 在这种情況下，有多少你要我做多少个??";
        ...
        if (qty == 1)
            ...
            prompt += qty + " #t" + item + "#?";
        prompt += " 在这种情況下，我要为了做出好的品质。请确保您是否有这么多空间可以放!#b";
