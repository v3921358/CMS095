...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        status++;
        if (status == 0)
            cm.sendSimple("您好，我是这间美髮店的老闆. 如果你有 #b#t5150001##k 或者有 #b#t5151001##k 请允許我把你的頭髮护理。请選擇一个你想要的.\r\n#L1#使用 #i5150001##t5150001##l\r\n#L2#使用 #i5151001##t5151001##l");
        else if (status == 1) {
            if (selection == 0) {
                beauty = 0;
                ...
                cm.sendStyle("選擇一个想要的.", hairnew, 5150001);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("選擇一个想要的", haircolor,5151001);
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
