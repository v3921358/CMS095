...
var status = -1;
var items;
var itemsp = Array(800, 500, 550, 2000, 800, 3000, 1000, 750, 1500);
var itemsu = Array(0, 2, 0, 0, 0, 0, 0, 0, 0, 0); // extra slots, not set.
var itemsq = Array(1, 1, 50, 1, 1, 1, 1, 1, 1, 1);
var itemse = Array(7, -1, -1, -1, -1, 30, 30, -1, -1, -1);
var extra_text = Array("2x Drop", "Brown Work Gloves", "Gachapon Ticket", "Purple Surfboard", "White Scroll", "Pet Itemvac", "Aura Pendant (Permanent)", "Lucky Day Scroll", "Protection Scroll");
var acash = 40000;
var acashp = 500;
var sel = -1;
var itt = -1;
...
function start() {
    ...
    if (cm.isGMS()) {
        ...
        items = Array(5360000, 1082149, 5220000, 1442057, 2340000, 4030003, 1122121, 2530000, 2531000);
        ...
        items = Array(5360017, 1082149, 5220000, 1442057, 2340000, 4030003, 1122121, 2530000, 2531000);
