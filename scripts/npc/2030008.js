    ...
    if (status == 0) {
        ...
        if (selection == 0) { //ZPQ
            ...
            if (teethmode == 2 && cm.haveItem(4031061) && cm.haveItem(4031062)) {
                ...
                cm.sendYesNo("好吧， 你已经完成了早期的阶段。  现在， 努力一点我可以帮你得到进入扎昆祭台所需要的 火焰的眼。 但是， 我的牙齿最近有点疼。  你见过一个牙医在冒险岛世界的故事吗？  哦，我听说殭尸们有几颗金牙。我需要你找到 #b30 个殭尸丢失的金齿#k 。这样我就可以自己制造一些假牙。然后我可以帮你拿到你想要的物品\r\n任务要求：\r\n#i4000082##b x 30 个");
            } else {
                cm.sendNext("请完成上一阶段的任务再来挑战此阶段。");
                cm.dispose();
            }
        ...
        if (cm.getPlayer().getMeso() < 30000000) {
            cm.sendNext("你好像没有足够的金币来支付，请检查一下再来。需要3000万");
