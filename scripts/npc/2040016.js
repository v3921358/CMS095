...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	var selStr = "額你是谁，你有听说过我鍛造的技能?? 在这种情況下，我会很高兴來处理你的一些矿石...但費用也是部便宜的！#b"
	...
	var prompt = "所以，你想要做一些 #t" + item + "#? 对我來说，他很容易!\r\n请问你講要做几个??";
	...
	prompt += "你想要做 #t" + item + "#? 在这种情況下, 我为了要做出最棒的品质，我建议你确保裝备栏空间足够。#b";
