...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "嗨，我是#p2040021# 今天可以为你做點什么？？#b"
        var options = new Array("什么是催化劑?", "做一双剑士鞋子", "做一双弓箭手鞋子", "做一双法师鞋子", "做一双盜賊鞋子",
                "做一双剑士鞋子使用催化劑", "做一双弓箭手鞋子使用催化劑", "做一双法师鞋子使用催化劑", "做一双盜賊鞋子使用催化劑");
        ...
        if (selectedType == 1) { //warrior shoe
            ...
            shoes = new Array("#t1072003##k - 剑士 等級. 30#b", "#t1072039##k - 剑士 等級. 30#b", "#t1072040##k - 剑士 等級. 30#b", "#t1072041##k - 剑士 等級. 30#b",
                    "#t1072002##k - 剑士 等級. 35#b", "#t1072112##k - 剑士 等級. 35#b", "#t1072113##k - 剑士 等級. 35#b",
                    "#t1072000##k - 剑士 等級. 40#b", "#t1072126##k - 剑士 等級. 40#b", "#t1072127##k - 剑士 等級. 40#b",
                    "#t1072132##k - 剑士 等級. 50#b", "#t1072133##k - 剑士 等級. 50#b", "#t1072134##k - 剑士 等級. 50#b", "#t1072135##k - 剑士 等級. 50#b");
            ;
            ...
            selStr = "很好，那么你想做哪一个？？#b";
            shoes = new Array("#t1072075##k - 法师 等級. 30#b", "#t1072076##k - 法师 等級. 30#b", "#t1072077##k - 法师 等級. 30#b", "#t1072078##k - 法师 等級. 30#b",
