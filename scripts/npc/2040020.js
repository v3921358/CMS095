...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "嗨，我是#p2040020# 今天可以为你做點什么？？#b"
        var options = new Array("什么是催化劑?", "做一双剑士手套", "做一双弓箭手手套", "做一双法师手套", "做一双盜賊手套",
                "做一双剑士手套使用催化劑", "做一双弓箭手手套使用催化劑", "做一双法师手套使用催化劑", "做一双盜賊手套使用催化劑");
        ...
        if (selectedType == 0) { //What's a stim?
            ...
            var items = new Array("#t1082007##k - 剑士 等級. 30#b", "#t1082008##k - 剑士 等級. 35#b", "#t1082023##k - 剑士 等級. 40#b", "#t1082009##k - 剑士 等級. 50#b");
            ...
            var selStr = "很好，那么你想做哪一个？？#b";
            var items = new Array("#t1082051##k - 法师 等級. 30#b", "#t1082054##k - 法师 等級. 35#b", "#t1082062##k - 法师 等級. 40#b", "#t1082081##k - 法师 等級. 50#b");
            for (var i = 0; i < items.length; i++) {
                selStr += "\r\n#L" + i + "# " + items[i] + "#l";
            }
            cm.sendSimple(selStr);
            ...
            var selStr = "很好，那么你想做哪一个？？#b";
            var crystals = new Array("#t1082005##k - 剑士 等級. 30#b", "#t1082006##k - 剑士 等級. 30#b", "#t1082035##k - 剑士 等級. 35#b", "#t1082036##k - 剑士 等級. 35#b",
                    "#t1082024##k - 剑士 等級. 40#b", "#t1082025##k - 剑士 等級. 40#b", "#t1082010##k - 剑士 等級. 50#b", "#t1082011##k - 剑士 等級. 50#b");
            ...
            var selStr = "很好，那么你想做哪一个？？#b";
            var items = new Array("#t1082052##k - 法师 等級. 30#b", "#t1082053##k - 法师 等級. 30#b", "#t1082055##k - 法师 等級. 35#b", "#t1082056##k - 法师 等級. 35#b",
                    "#t1082063##k - 法师 等級. 40#b", "#t1082064##k - 法师 等級. 40#b", "#t1082082##k - 法师 等級. 50#b", "#t1082080##k - 法师 等級. 50#b");
            for (var i = 0; i < items.length; i++) {
                selStr += "\r\n#L" + i + "# " + items[i] + "#l";
            }
            cm.sendSimple(selStr);
        ...
        var prompt = "你想要做一双 #t" + item + "#? 在这种情況下，为了要做出好品质的裝备。请确保您有空间在您的裝备栏！#b";
