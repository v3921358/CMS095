...
var job = [
[[100, "Warrior"], [200, "Magician"], [300, "Bowman"], [400, "Thief"], [500, "Pirate"], [532, "Cannoneer"], [3100, "Demon Slayer"], [2300, "Mercedes"], [430, "Blade Lord"]],
[[1100, "Dawn Warrior"], [1200, "Blaze Wizard"], [1300, "Wind Archer"], [1400, "Night Walker"], [1500, "Thunder Breaker"], [530, "Cannoneer"], [3100, "Demon Slayer"], [2300, "Mercedes"]],
[[3200, "Battle Mage"], [3300, "Wild Hunter"], [3500, "Mechanic"],  [530, "Cannoneer"], [3100, "Demon Slayer"], [2300, "Mercedes"]],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayer().getLevel() >= 10 && (cm.getPlayer().getJob() % 1000 == 0 || cm.getPlayer().getJob() == 3001 || cm.getPlayer().getJob() >= 2001 && cm.getPlayer().getJob() <= 2003) || cm.getPlayer().getLevel() >= 30 && cm.getPlayer().getJob() % 1000 > 0 && cm.getPlayer().getJob() % 100 == 0 || cm.getPlayer().getLevel() >= 70 && cm.getPlayer().getJob() % 10 == 0 && cm.getPlayer().getJob() % 100 != 0 || cm.getPlayer().getLevel() >= 120 && cm.getPlayer().getJob() % 10 == 1 || cm.getPlayer().getLevel() >= 55 && cm.getPlayer().getJob() == 431)
