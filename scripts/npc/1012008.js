...
function action(mode, type, selection) {
	...
	if (status == 0) {
		cm.sendSimple("嘿！你好像打猎打累了？享受快乐生活是我的信念。怎么樣？只要有几种道具，我就給你更換能玩小游戏的道具。嗯。。。帮你甚么好呢？\r\n#b#L0#制作小游戏道具#l\r\n#b#L1#听听小游戏的说明#l");
	} else if (status == 1) {
		if (selection == 0) {
		...
		if (select == 2) {
			...
			if (!cm.haveItem(4030012, 15)) {
				cm.sendNext("请准备好材料。 找碴需要 #b15#k 张#t4030012# ！");
				cm.dispose();
				return;
			} else {
		...
		if (select == 2) {
			cm.sendSimple("那么，你想要做哪种形狀的五子棋呢？？\r\n#b#L6##t4080000##l#k\r\n#b#L7##t4080001##l#k\r\n#b#L8##t4080002##l#k\r\n#b#L9##t4080003##l#k\r\n#b#L10##t4080004##l#k\r\n#b#L11##t4080005##l#k");
		}
	} else if (status == 4) {
		if (selection == 6) {
			if (!cm.haveItem(4030000, 99) || !cm.haveItem(4030001, 99) || !cm.haveItem(4030009, 1)) {
				cm.sendNext("请准备好材料。 #t4080000#需要 #b99#k 个#t4030000#和#t4030001# 和 #b1#k 个 #t4030009# ！");
			} else {
			...
			if (!cm.haveItem(4030000, 99) || !cm.haveItem(4030010, 99) || !cm.haveItem(4030009, 1)) {
				cm.sendNext("请准备好材料。 #t4080001#需要 #b99#k 个#t4030000#和#t4030010# 和 #b1#k 个 #t4030009# ！");
			} else {
				cm.gainItem(4030000, -99);
			...
			if (!cm.haveItem(4030000, 99) || !cm.haveItem(4030011, 99) || !cm.haveItem(4030009, 1)) {
				cm.sendNext("请准备好材料。 #t4080002#需要 #b99#k 个#t4030000#和#t4030011# 和 #b1#k 个 #t4030009# ！");
			} else {
				cm.gainItem(4030000, -99);
			...
			if (!cm.haveItem(4030010, 99) || !cm.haveItem(4030001, 99) || !cm.haveItem(4030009, 1)) {
				cm.sendNext("请准备好材料。 #t4080003#需要 #b99#k 个#t4030010#和#t4030001# 和 #b1#k 个 #t4030009# ！");
			} else {
				cm.gainItem(4030010, -99);
				cm.gainItem(4030001, -99);
				cm.gainItem(4030009, -1);
			...
			if (!cm.haveItem(4030011, 99) || !cm.haveItem(4030010, 99) || !cm.haveItem(4030009, 1)) {
				cm.sendNext("请准备好材料。 #t4080004#需要 #b99#k 个#t4030011#和#t4030010# 和 #b1#k 个 #t4030009# ！");
			} else {
				cm.gainItem(4030011, -99);
				cm.gainItem(4030010, -99);
				cm.gainItem(4030009, -1);
			...
			if (!cm.haveItem(4030011, 99) || !cm.haveItem(4030001, 99) || !cm.haveItem(4030009, 1)) {
				cm.sendNext("请准备好材料。 #t4080005#需要 #b99#k 个#t4030011#和#t4030001# 和 #b1#k 个 #t4030009# ！");
			} else {
				cm.gainItem(4030011, -99);
				cm.gainItem(4030001, -99);
				cm.gainItem(4030009, -1);
