...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("嗨我是#p2090100# 如果你有 #b#t5150025##k, 或者有 #b#t5151020##k, 我就可以帮助你 選擇一个服務\r\n#L0#使用: #i5150025##t5150025##l\r\n#L1#使用: #i5151020##t5151020##l");
    } else if (status == 1) {
        if (selection == 0) {
            ...
            cm.askAvatar("選擇一个你想要的。", 5150025, hair_Colo_new);
        } else if (selection == 1) {
            ...
            cm.askAvatar("選擇一个你想要的。", 5151020, hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {
            if (cm.setAvatar(5150025, hair_Colo_new[selection]) == 1) {
                ...
                cm.sendOk("痾...似乎沒有#b#t5150025##k");
            }
        } else {
            if (cm.setAvatar(5151020, hair_Colo_new[selection]) == 1) {
                cm.sendOk("享受!");
            } else {
                cm.sendOk("痾...似乎沒有#b#t5151020##k");
            }
        }
        cm.dispose();
    }
