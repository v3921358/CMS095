    ...
    switch (cm.getPlayer().getMapId()) {
        ...
        case 920010600: //lounge
            if (!cm.haveItem(4001052, 30)) {
                cm.sendOk("我需要#b#t4001052# 30个#k，目前有#c4001052#个。");
            } else {
        ...
        case 920010800:
            ...
            break;
        case 920010900:
            cm.sendNext("这是塔的监狱。你可能会发现一些好吃的东西在这里，但除此之外，我不认为我们有什麽在这里件。");
            break;
        case 920011000:
            cm.sendNext("这是隐藏的房间塔。你可能会发现一些好吃的东西在这里，但除此之外，我不认为我们有什麽在这里件。");
            break;
    }
    cm.dispose();
}
