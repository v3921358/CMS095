...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendSimple("嗨，我是#p1012104# 如果你有 #b#t5150000##k 或者 #b#t5151000##k, 我就可以免費帮你弄好看的頭髮。 \r\n#L0#使用: #i5150000##t5150000##l\r\n#L1#使用: #i5151000##t5151000##l");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.sendYesNo("确定要使用 #b#t5150000##k 隨機剪髮了？？");
	    ...
	    cm.sendYesNo("确定要使用 #b#t5151000##k 隨機染髮了？？");
	}
    } else if (status == 2){
	if (beauty == 1){
