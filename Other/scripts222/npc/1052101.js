...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		cm.sendSimple("我是安德里亞. 如果你有 #b#t5151002##k \r\n或者 #b#t5150002##k 任何機会，\r\n那么怎么樣让我改变你的髮型顏色?\r\n#L0#使用 #b#t5150002##k\r\n#L1#使用 #b#t5151002##k");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.sendYesNo("注意!这是隨機，请问是否要使用 #b#t5150002##k?");
	} else if (selection == 1) {
	    ...
	    cm.sendYesNo("注意!这是隨機，请问是否要使用 #b#t5151002##k?");
	}
    } else if (status == 2){
	if (beauty == 1){
		...
		cm.sendOk("您貌似沒有#b#t5150002##k..");
	    }
	} else {
	    if (cm.setRandomAvatar(5151002, hair_Colo_new) == 1) {
		cm.sendOk("享受!");
	    } else {
		cm.sendOk("您貌似沒有#b#t5151002##k..");
	    }
	}
	cm.dispose();
    }
