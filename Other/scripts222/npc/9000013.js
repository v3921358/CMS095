...
function start() {
    cm.sendNext("嗨 我是 #b東尼#k. 我在等待我的大哥 #b江#k. 他應該现在在这里...");
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 1) {
            cm.sendNextPrev("嗯......我該怎么辦？本次活动将开始，很快......很多人去參与这项活动，所以我们最好快點來......");
        } else if (status == 2) {
            cm.sendSimple("嗨... 你为什么不跟我走？我想我的兄弟会与其他人...\r\n#L0##e1.#n#b 什么樣的活动內容??#k#l\r\n#L1##e2.#n#b 介紹活动內容让我认識..#k#l\r\n#L2##e3.#n#b 好了，我们走吧！#k#l");
        } else if (status == 3) {
            if (selection == 0) {
                cm.sendNext("所有本月初，冒險島環球慶祝其三周年！全球機制将舉行驚喜GM活动在整个活动期间，所以留在你的脚趾，並确保參与活动的至少一个为偉大的獎品！");
                cm.dispose();
            } else if (selection == 1) {
                cm.sendSimple("有許多活动官則。这将帮助在你开始活动之前。好了...選擇你想了解的活动.. #b\r\n#L0# 爬繩子#l\r\n#L1# 终極忍耐#l\r\n#L2# 滾雪球#l\r\n#L3# 打果子#l\r\n#L6# 打瓶蓋#l\r\n#L4# 是非題大考验#l\r\n#L5# 尋寶#l#k");
            } else if (selection == 2) {
				if (!cm.canHold()) {
					...
					cm.sendNext("活动尚未开放，请确认是否你有在24小时內參加过一个活动。请稍后在试！");
				}
				cm.dispose();
			}
        } else if (status == 4) {
            if (selection == 0) {
                ...
                cm.sendNext("#b[终極忍耐] 自己#e#rGoogle#k!");
                cm.dispose();
            } else if (selection == 2) {
                ...
                cm.sendNext("#b[是非題大考验]#k 自己#e#rGoogle#k!");
                cm.dispose();
            } else if (selection == 5) {
