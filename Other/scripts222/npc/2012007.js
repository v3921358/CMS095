...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendSimple("我是利納斯助手. 请问你有 #b#t5150004##k or #b#t5151004##k 嘛? 如果是这樣，您考慮让我如何把你的頭髮护理？ 你想要怎樣护理你的頭髮? \r\n#L0#使用: #i5150004##t5150004##l \r\n#L1#使用: #i5151004##t5151004##l");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.sendYesNo("这是隨機是否要使用 #b#t5150004##k ？？");
	} else if (selection == 1) {
	    ...
	    cm.sendYesNo("这是隨機是否要使用 #b#t5151004##k ？？");
	}
    } else if (status == 2){
	if (beauty == 1) {
