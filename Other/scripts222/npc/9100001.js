...
function start() {
    cm.sendSimple("I could make use of your maple leaves. Heres what i can offer! \r\n\r\n#b#L0#Trade for a Level 35 Maple Weaponl#l \r\n\r\n#L1#Trade for a Level 43 Maple Weapon#l*\r\n\r\n#L2#Trade for a Level 64 Maple Weapon#l\r\n\r\n#L4#Trade for a Level 77 Maple Weapon#l\r\n\r\n#L3#Trade for Experience Pointsl#k");
}
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (sel == 0) {
            ...
            cm.sendSimple("So, wotcha want? \r\n\r\n#b#L0#Gold Master Key#l \r\n\r\n#b#L1# Silver Master Key#l");
        } else if (sel == 3) {
        ...
        if (sel == 0) {
            ...
            if (selection == 0) {
                newWepName = "Gold Master Key";
                newWepId = 5490000;
                leaves = 1000;
                cost = 100000;
            } else if (selection == 1) {
                newWepName = "Silver Master Key";
                newWepId = 5490001;
                leaves = 800;
                cost = 50000;
            }
            cm.sendYesNo("Are you sure you want to buy a #b" + newWepName + "#k? The following items and materials will be required...\r\n\#i4001126# x" + leaves + "#k\r\n\r\n#fUI/UIWindow.img/QuestIcon/7/0# " + cost);
