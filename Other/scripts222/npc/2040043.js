...
function clear(stage, eim, cm) {
    ...
    cm.givePartyExp(10000, eim.getPlayers());
    ...
    if (cm.isLeader()) { // leader
        if (status == 0) {
            ...
            if (preamble == null) {
                ...
                eim.setProperty("stage" + nthtext + "combo", cm.getDoubleFloor(cm.getDoubleRandom() * curcombo.length).toString());
                cm.dispose();
                ...
                if (complete != null) {
                    ...
                    if (totplayers == 5 || debug) {
                        ...
                        if (debug) {
                            ...
                            cm.sendNext("需要5名队员站在箱子上组成不同的组合。只允许5名队员站在箱子上, 请记住你们已经使用过的错误组合,方便快速通关。");
                            clear(8, eim, cm);
							cm.dispose();
                        }
                    }
