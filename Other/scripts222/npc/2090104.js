...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("嗨，我是#p2090104# 我在#b桃花仙境#k 这个地方是很有名的整形师，甚至比我师父还厲害！ 如果你有 #b#t5152027##k或者 #b#t5152028##k, 我可以帮你改变你想要的臉型。 \r\n#L0#使用: #i5152027##t5152027##l\r\n#L1#使用: #i5152028##t5152028##l");
    } else if (status == 1) {
        ...
        if (selection == 0) {
            beauty = 1;
            cm.sendYesNo("是否要使用 #b#t5152027##k #r注意:他是隨機#k?");
        } else if (selection == 1) {
            beauty = 2;
            cm.askAvatar("選擇一个你喜欢的。", 5152028, facetype);
        }
    } else if (status == 2) {
        if (beauty == 1) {
            if (cm.setRandomAvatar(5152027, facetype) == 1) {
                ...
                cm.sendOk("痾...貌似沒有#b#t5152027##k。");
            }
        } else {
            if (cm.setAvatar(5152028, facetype[selection]) == 1) {
                cm.sendOk("享受!");
            } else {
                cm.sendOk("痾...貌似沒有#b#t5152028##k。");
            }
        }
        cm.safeDispose();
    }
