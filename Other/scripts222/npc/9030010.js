...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        +"#k\r\n#L16#Trade 1 #v4031306# for #v1312062#"
	...
	cm.gainItem(1092079, 1);
        ...
        if(cm.haveItem(4031306, 1)){
        cm.gainItem(4031306, -1);
        cm.gainItem(1422063, 1);
        cm.sendOk("Thanks, here is your #v1422063#.");
        }
        else {
        cm.sendOk("You don't have #v4031306#");
        }
        ...
        if(cm.haveItem(4031306, 1)){
        cm.gainItem(4031306, -1);
        cm.gainItem(1312062, 1);
        cm.sendOk("Thanks, here is your #v1312062#.");
        }
        else {
        cm.sendOk("You don't have #v4031306#");
        }
