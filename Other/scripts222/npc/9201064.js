...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("嗨，我是#p9201064# 如果您有 #b#t5150031##k 或者有 #b#t5151026##k 我就可以帮助您~ 選擇您想要的服務 \r\n#L0#使用: #i5150031##t5150031##l\r\n#L1#使用: #i5151026##t5151026##l");
    } else if (status == 1) {
        if (selection == 0) {
            ...
            cm.askAvatar("選擇一个喜欢的", 5150031, hair_Colo_new);
        } else if (selection == 1) {
            ...
            cm.askAvatar("選擇一个喜欢的", 5151026, hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {
