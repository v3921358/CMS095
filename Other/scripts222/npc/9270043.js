...
function action(mode, type, selection) {
	...
	var item;
	if (cm.getDoubleFloor(cm.getDoubleRandom() * 300) == 0) {
	    var rareList = new Array(3010022, 1372041, 1372042, 2049100, 1082149);
	    ...
	    item = cm.gainGachaponItem(itemList[cm.getDoubleFloor(cm.getDoubleRandom()
                        * itemList.length)], 1);
	}
