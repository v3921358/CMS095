        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                if (pet == null || !cm.haveItem(5380000, 1)) {
                    ...
                    var after = id;
                    while (after == id) {
                        rand = 1 + cm.getDoubleFloor(cm.getDoubleRandom() * 10);
                        if (rand >= 1 && rand <= 3) {
                            after = 5000030;
                ...
                if (pet == null || !cm.haveItem(5380000, 1)) {
                    ...
                    var after = id;
                    while (after == id) {
                        rand = 1 + cm.getDoubleFloor(cm.getDoubleRandom() * 9);
                        if (rand >= 1 && rand <= 2) {
                            after = 5000049;
                    ...
                    cm.gainPet(after, name, level, closeness, fullness, 45);
                    cm.getPlayer().spawnPet(slot);
                    cm.sendOk("您的机器人已经进化了！它曾经是一隻 #i" + id + "##t" + id + "#, 而现在是一隻 #i" + after + "##t" + after + "#!");
                    cm.dispose();
                }
            } else if (selection == 3) {
