...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("欢迎~欢迎 來到玩具城美髮店! 如果你有 #b#t5150007##k 或者 #b#t5151007##k? 我就可以帮你改变 请選擇要哪种服務: \r\n#L0#使用: #i5150007##t5150007##l\r\n#L1#使用: #i5151007##t5151007##l");
    } else if (status == 1) {
        if (selection == 0) {
            ...
            cm.askAvatar("選擇一个你喜欢的", 5150007, hair_Colo_new);
        } else if (selection == 1) {
            ...
            cm.askAvatar("選擇一个你喜欢的", 5151007, hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {
            if (cm.setAvatar(5150007, hair_Colo_new[selection]) == 1) {
                ...
                cm.sendOk("痾..貌似沒有#t5150007#");
            }
        } else {
            if (cm.setAvatar(5151007, hair_Colo_new[selection]) == 1) {
                cm.sendOk("享受!");
            } else {
                cm.sendOk("痾..貌似沒有#t5151007#");
            }
        }
        cm.dispose();
    }
