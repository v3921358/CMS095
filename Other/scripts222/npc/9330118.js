...
var daoju = 5220000;
var itemList = Array(     
            Array(2046006,150,1,0),//头盔智力卷轴 诅咒~30%
		    Array(2046007,150,1,0),//头盔智力卷轴 诅咒~30%
		    Array(2046106,150,1,0),//头盔智力卷轴 诅咒~30%
		    Array(2046107,150,1,0),//头盔智力卷轴 诅咒~30%
			Array(2046214,150,1,0),//头盔智力卷轴 诅咒~30%
		    Array(2046309,150,1,0),//头盔智力卷轴 诅咒~30%
			Array(2046222,100,1,0),//头盔智力卷轴 诅咒~30%
		    Array(2046311,100,1,0),//头盔智力卷轴 诅咒~30%
		
			
			Array(2049130,50,1,0),//头盔智力卷轴 诅咒~30%		
			Array(2049131,30,1,0),//头盔智力卷轴 诅咒~30%		
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.haveItem(daoju,1)) {
            cm.sendSimple("冒险岛#r#p"+npc+"##k中有各类#b卷轴#k噢！使用“#b#t"+daoju+"##k”就可以抽奖，否则是不可以使用我的。现在要玩转蛋机么? \r\n#b#L2#试试手气吧#l#k\r\n#b#L4#十连抽#l\r\n\r\n部分奖励展示:\r\n" + jpzs);
        } else {
        	cm.sendSimple("冒险岛#r#p"+npc+"##k中有各类#b卷轴#k噢！使用“#b#t"+daoju+"##k”就可以交换。 \r\n你没有#r#z"+daoju+"##v"+daoju+"#\r\n#k\r\n#k部分奖励展示:\r\n\r\n" + jpzs +"");
            cm.dispose();
        }
    } else if (selection == 2) {
        ...
        if (finalitem.length != 0) {
            ...
            if (item != -1) {
               ...
               // cm.gainItem(4000508,1);
                ...
                cm.sendOk("你确实有#b#t"+daoju+"##k吗？如果是，请你确认在背包的装备，消耗，其他窗口中是否有一格以上的空间。");
            }
            cm.safeDispose();
        } else {
		...
		var itemids = [];
		if (!cm.haveItem(daoju,10)){
			cm.sendOk("你的 #b#t"+daoju+"# #k不够 #r10 #k张，无法抽奖。");
			cm.dispose();
			return;
		}
		...
		if (cm.getMeso() < 2000000){
			cm.sendOk("购买#v5220000#需要 #b金币 2000000 #k您的金币不足");
			cm.dispose();
			return;
		}
		cm.gainMeso(-2000000);
