...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        var options = new Array("做一双/升級剑士手套", "做一双/升級弓箭手手套", "做一双/升級法师手套", "做一双/升級盜賊手套");
        ...
        if (selectedType == 0) { //warrior glove
            var selStr = "需要什么吗？？#b";
            var gloves = new Array("#t1082103##k - 剑士 等級. 70#b", "#t1082104##k - 剑士 等級. 70#b", "#t1082105##k - 剑士 等級. 70#b",
                    "#t1082114##k - 剑士 等級. 80#b", "#t1082115##k - 剑士 等級. 80#b", "#t1082116##k - 剑士 等級. 80#b", "#t1082117##k - 剑士 等級. 80#b");
            ...
            var selStr = "需要什么吗？？#b";
            var gloves = new Array("#t1082098##k - 法师 等級. 70#b", "#t1082099##k - 法师 等級. 70#b", "#t1082100##k - 法师 等級. 70#b",
                    "#t1082121##k - 法师 等級. 80#b", "#t1082122##k - 法师 等級. 80#b", "#t1082123##k - 法师 等級. 80#b");
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
