...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            beauty = 2;
            cm.askAvatar("With our specialized machine, you can see yourself after the treatment in advance. What kind of lens would you like to wear? Choose the style of your liking.", 5152013, hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {
