...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0) {
        var selStr = "我喜欢你的態度！我们只是照顧这个现在。你喜欢什么樣的矿石提炼? #b";
        var options = new Array("提炼矿石", "提炼的寶石矿", "細化晶矿石");
        ...
        if (selectedType == 0) { //mineral refine
            var selStr = "選擇一个你提炼的矿石?#b";
            var minerals = new Array("青銅", "鋼鐵", "鋰矿石", "朱矿石", "銀", "紫矿石", "黃金", "鋰");
            ...
            var selStr = "選擇一个你提炼的寶石矿?#b";
            var jewels = new Array("石榴石", "紫水晶", "海藍寶石", "祖母绿", "蛋白石", "藍寶石", "黃晶", "鑽石", "黑水晶");
        ...
        prompt += " 在这种情況下，我会为了让需要你的具體项目。请确保您有足够的空间在您的庫存！#b";
        ...
        if (!complete)
            cm.sendOk("我不能接受的替代品。如果你沒有什么我需要的東西的话，我就不能來帮你.");
        else {
            if (mats instanceof Array) {
                for (var i = 0; i < mats.length; i++) {
            ...
            cm.sendNext("嗯...我差點沒想到会工作的第二个......好吧，反正我希望你喜欢它.");
        }
        cm.dispose();
    }
}