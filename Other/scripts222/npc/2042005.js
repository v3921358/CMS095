...
function action(mode, type, selection) {
	...
	var found = false;
		...
		if (found) {
		    ...
		    cm.sendSimple("目前沒有房间.\r\n#L100#兌換黃金枫葉標誌#l");
		}
            } else {
                cm.sendSimple("请叫你的队长來找我\r\n#L100#枫葉黃金標誌兌換#l");
            }
        }
    } else if (status == 1) {
	if (selection == 100) {
	    cm.sendSimple("#b#L0#50个枫葉黃金標誌 = 休菲凱曼的混亂项鍊#l\r\n#L1#30个枫葉黃金標誌 = 休菲凱曼的珠子#l\r\n#L2#50个閃亮的枫葉黃金標誌 = 休菲凱曼的混亂项鍊#l#k");
		...
		if (!cm.haveItem(4001129,50)) {
		    cm.sendOk("很抱歉您並沒有#t4001129# #b50#k个");
		...
		if (!cm.haveItem(4001129,30)) {
		    cm.sendOk("很抱歉您並沒有#t4001129# #b30#k个");
		...
		if (!cm.haveItem(4001254,50)) {
		    cm.sendOk("很抱歉您並沒有#t4001254# #b50#k个");
