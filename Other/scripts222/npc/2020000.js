...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        var options = new Array("做一些矿石", "提炼一些寶石矿", "提炼一些高級寶石矿", "提炼一些高級水晶", "做一些物料", "做一些弓箭");
        ...
        if (selectedType == 0) { //mineral refine
            ...
            var selStr = "需要什么吗？？#b";
            var materials = new Array("#t4003001#", "#t4003001#", "#t4003000# (一組15个)");
        ...
        var prompt = "你想要做一些 #t" + item + "#? 在这种情況下, 我为了要做出最棒的品质，我建议你确保裝备栏空间足够。#b";
        ...
        prompt += " 我为了要做出最棒的品质，我建议你确保裝备栏空间足够。#b";
