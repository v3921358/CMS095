 ...
 **/
 ...
 var bosslist = Array(
  ...
  //   Array('森兰丸', 9410248, 807300110, 'BossRanmaru', 五角星 + 五角星 + 五角星,'#v1003601##v1052511##v1072714#'),
     Array('浓姬-白金', 9450022, 811000080, 'BossPrincess', 五角星 + 五角星 + 五角星 + 五角星,'#v1113074##v1162045##v1162035#'),
     Array('麦格纳斯-橙金', 9303100, 922900800, 'BossMagnus', 五角星 + 五角星 + 五角星 + 五角星 + 五角星,'#v1072746##v1102484##v1132245#'),
     Array('绯红四傻-紫金', Array(8900000, 8910000, 8920000, 8930000), 105200410, 'BossBelen', 五角星 + 五角星 + 五角星 + 五角星 + 五角星 + 五角星,'#v1382269##v1122267##v1042255#')
 )
 ...
 function action(mode, type, selection) {
     if (mode == -1) {
         ...
         if (status === 0) {
             var text = " \t\t\t #r#e积分BOSS挑战中心#n#k#l \r\n";
             for (var i = 0; i < bosslist.length; i++) {
                 text += "#L" + i + "#" + bosslist[i][0] + "【" + bosslist[i][4] + "】" +  bosslist[i][5]+"#l" + rn;
             }
             text += "  ";
             cm.sendOk(text);
         } else if (status === 1) {
