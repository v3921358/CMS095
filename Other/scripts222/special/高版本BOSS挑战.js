 ...
 **/
 ...
 var bosslist = Array(
    ...
    // Array('浓姬', 9450022, 211042301, 'BossPrincess', 五角星 + 五角星 + 五角星 + 五角星,'#v1113074##v1162045##v1162035#'),
    // Array('麦格纳斯', 9303100, 922900800, 'BossMagnus', 五角星 + 五角星 + 五角星 + 五角星 + 五角星,'#v1072746##v1102484##v1132245#'),
    // Array('绯红四傻', Array(8900000, 8910000, 8920000, 8930000), 105200410, 'BossBelen', 五角星 + 五角星 + 五角星 + 五角星 + 五角星 + 五角星,'#v1382269##v1122267##v1042255#')
 )
 ...
 function action(mode, type, selection) {
     if (mode == -1) {
         ...
         if (status === 0) {
             var text = "   "+ ccx + "#d#e高版本BOSS体验中心#n#k" + ccx + "#l \r\n";
