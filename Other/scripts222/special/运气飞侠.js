...
var 选择的分解装备; 
var 获得分解材料数量 = 0;
var 低级赛手装备 = Array(1003200,1052336,1072505,1082308,1032031,1152194);//到12不动
var 高级女皇装备 = Array(1002779,1052158,1072358,1082237,1472068,1332074);

var 低级女皇装备 = Array(1002779,1052158,1072358,1082237,1472068);
var 高级女神装备 = Array(1003773,1052583,1072789,1082509,1102517);

var 低级女神装备 = Array(1003773,1052583,1072789,1082509,1102517,1472068,1332074);
var 高级神圣装备 = Array(1003157,1052302,1072474,1082288,1102265,1472118,1332126);

var 低级神圣装备 = Array(1003157,1052302,1072474,1082288,1102265,1472118,1332126,1132097);//到一不动
var 高级革命装备 = Array(1003175,1052317,1072488,1082298,1102278,1472122,1332130,1152112);

var 低级革命装备 = Array(1003175,1052317,1072488,1082298,1102278,1472122,1332130,1152112);
var 高级宝藏装备 = Array(1003800,1042257,1062168,1082336,1102479,1472269,1332283,1132172);//到一二改法不一样

var 低级全系列 = Array(1003200,1052336,1072505,1082308,1132097,1032031,1152194);//到123不动
function start() {
    status = -1;
    action(1, 0, 0);
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "   #L1##v"+低级赛手装备[1]+"##b#e迷雾漫步#k#n升级#r#e永恒套装#k#n[#g飞侠#k]#v"+高级女皇装备[1]+"##l\r\n";
			text += "   #L2##v"+低级女皇装备[1]+"##b#e永恒套装#k#n升级#r#e皇家迅捷#k#n[#g飞侠#k]#v"+高级女神装备[1]+"##l\r\n";
			text += "   #L3##v"+低级女神装备[1]+"##b#e皇家迅捷#k#n升级#r#e雷昂套装#k#n[#g飞侠#k]#v"+高级神圣装备[1]+"##l\r\n";
			text += "   #L4##v"+低级神圣装备[1]+"##b#e雷昂套装#k#n升级#r#e渡鸦套装#k#n[#g飞侠#k]#v"+高级革命装备[1]+"##l\r\n";
			text += "   #L5##v"+低级革命装备[1]+"##b#e渡鸦套装#k#n升级#r#e鲁塔比斯#k#n[#g飞侠#k]#v"+高级宝藏装备[1]+"##l\r\n";
			text += "\r\n ";
		cm.sendSimple(text);
		} else if (status == 1) {
			 if (selection == 1) {
