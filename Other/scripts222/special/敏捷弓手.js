...
var 选择的分解装备; 
var 获得分解材料数量 = 0;
var 低级赛手装备 = Array(1003199,1052335,1072504,1082307,1032031,1152194);
var 高级女皇装备 = Array(1002778,1052157,1072357,1082236,1452057,1462050);

var 低级女皇装备 = Array(1002778,1052157,1072357,1082236,1452057);
var 高级女神装备 = Array(1003772,1052582,1072788,1082508,1102516);

var 低级女神装备 = Array(1003772,1052582,1072788,1082508,1102516,1462050,1452057);
var 高级神圣装备 = Array(1003156,1052301,1072473,1082287,1102264,1452107,1462094);

var 低级神圣装备 = Array(1003156,1052301,1072473,1082287,1102264,1452107,1462094,1132096);
var 高级革命装备 = Array(1003174,1052316,1072487,1082297,1102277,1452111,1462099,1152111);

var 低级革命装备 = Array(1003174,1052316,1072487,1082297,1102277,1452111,1462099,1152111);
var 高级宝藏装备 = Array(1003799,1042256,1062167,1082335,1102478,1452261,1462247,1132171);
var 低级全系列 = Array(1003199,1052335,1072504,1082307,1132096,1032031,1152194);
function start() {
    status = -1;
    action(1, 0, 0);
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "   #L1##v"+低级赛手装备[1]+"##b#e清风漫步#k#n升级#r#e永恒套装#k#n[#g弓箭手#k]#v"+高级女皇装备[1]+"##l\r\n";
			text += "   #L2##v"+低级女皇装备[1]+"##b#e永恒套装#k#n升级#r#e皇家锋锐#k#n[#g弓箭手#k]#v"+高级女神装备[1]+"##l\r\n";
			text += "   #L3##v"+低级女神装备[1]+"##b#e皇家锋锐#k#n升级#r#e雷昂套装#k#n[#g弓箭手#k]#v"+高级神圣装备[1]+"##l\r\n";
			text += "   #L4##v"+低级神圣装备[1]+"##b#e雷昂套装#k#n升级#r#e龙尾套装#k#n[#g弓箭手#k]#v"+高级革命装备[1]+"##l\r\n";
			text += "   #L5##v"+低级革命装备[1]+"##b#e鹰翼套装#k#n升级#r#e鹰翼比斯#k#n[#g弓箭手#k]#v"+高级宝藏装备[1]+"##l\r\n";
			text += "\r\n ";
		cm.sendSimple(text);
		} else if (status == 1) {
			 if (selection == 1) {
