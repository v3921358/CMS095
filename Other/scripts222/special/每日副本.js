...
function action(mode, type, selection) {
	if (mode == -1) {
		cm.dispose();
			...
			if (mode == 1) {
				...
				var 副本1 = getFbLog("副本1",1);
				var 副本1次数 = getFbLog("副本1",2);
				var 副本2 = getFbLog("副本2",1);
				var 副本2次数 = getFbLog("副本2",2);
				var 副本3 = getFbLog("副本3",1);
				var 副本3次数 = getFbLog("副本3",2);
	...
	var text = "";
		...
		text += ""+无条件获得+"\r\n#v5220010##z5220010#×10 #v2022336##z2022336#×10\r\n#v4031559##z4031559#×100 #v4002003##z4002003#×5\r\n#v4001465##z4001465#×20 #v4002002##z4002002#×100\r\n"
            ...
            if(cm.getPlayer().getBossLogD("MRFB") > 0) {
				...
				cm.dispose();
					...
					if (cm.getInventory(1).isFull(4)) {
						...
						cm.gainMeso(等级*9000*3.2);
						cm.gainExp(等级*等级*等级*3.2);
						cm.gainItem(5220010,10);
						cm.gainItem(2022336,10);
