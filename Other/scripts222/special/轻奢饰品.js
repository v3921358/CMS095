...
var 三级链接;
var 分解材料 = 4000313;
var 所需数量 = Array(0,30,5,1);//10为升级所需数量 3为兑换所需数量 1为分解获得数量
var 选择的赛手装备;
var 选择的赛手装备位置;
var 选择的女皇装备;
var 选择的女皇装备位置;
...
var 选择的分解装备; 
var 获得分解材料数量 = 0;
var 低级赛手装备 = Array(1012187,1012188,1012189,1012191);
var 高级女皇装备 = Array(1012188,1012189,1012191,1012414);

var 低级女皇装备 = Array(1132246,1032223,1113075,1122267);
var 高级女神装备 = Array(1022195,1032201,1113056,1122259);

var 低级女神装备 = Array(1142001,1142484,1142485,1142486,1142487,1142488);
var 高级神圣装备 = Array(1142484,1142485,1142486,1142487,1142488,1143000);
...
var 低级全系列 = Array(1012187,1142001);
function start() {
    status = -1;
    action(1, 0, 0);
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "   #L1##v"+低级赛手装备[0]+"##b#e面巾脸饰#k#n升级#r#e超越脸饰#k#n[#g脸饰#k]#v"+高级女皇装备[3]+"##l\r\n";
			text += "   #L3##v"+低级女神装备[0]+"##b#e可爱玩家#k#n升级#r#e毕业大佬#k#n[#g称号#k]#v"+高级神圣装备[5]+"##l\r\n";	
		    text += "#L2##v"+低级女皇装备[1]+"##b#e最高级贝勒德#k#n升级#r#e全系超越证明#k#n[#g全系#k]#v"+高级女神装备[1]+"##l\r\n";
