...
var 选择的分解装备; 
var 获得分解材料数量 = 0;
var 低级赛手装备 = Array(1003201,1052337,1072506,1082309,1032031,1152194);//到12不动
var 高级女皇装备 = Array(1002780,1052159,1072359,1082238,1482023,1492023);

var 低级女皇装备 = Array(1002780,1052159,1072359,1082238,1482023);
var 高级女神装备 = Array(1003774,1052584,1072790,1082510,1102518);

var 低级女神装备 = Array(1003774,1052584,1072790,1082510,1102518,1482023,1492023);
var 高级神圣装备 = Array(1003158,1052303,1072475,1082289,1102266,1482080,1492081);

var 低级神圣装备 = Array(1003158,1052303,1072475,1082289,1102266,1482080,1492081,1132098);//到一不动
var 高级革命装备 = Array(1003176,1052318,1072489,1082299,1102279,1482084,1492085,1152113);

var 低级革命装备 = Array(1003175,1052317,1072488,1082298,1102278,1482084,1492085,1152113);
var 高级宝藏装备 = Array(1003801,1042258,1062169,1082337,1102480,1482225,1492239,1132173);//到二三改法不一样

var 低级全系列 = Array(1003201,1052337,1072506,1082309,1132098,1032031,1152194);//到123不动
function start() {
    status = -1;
    action(1, 0, 0);
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "   #L1##v"+低级赛手装备[1]+"##b#e幸运漫步#k#n升级#r#e永恒套装#k#n[#g海盗#k]#v"+高级女皇装备[1]+"##l\r\n";
			text += "   #L2##v"+低级女皇装备[1]+"##b#e永恒套装#k#n升级#r#e皇家炽热#k#n[#g海盗#k]#v"+高级女神装备[1]+"##l\r\n";
			text += "   #L3##v"+低级女神装备[1]+"##b#e皇家炽热#k#n升级#r#e雷昂套装#k#n[#g海盗#k]#v"+高级神圣装备[1]+"##l\r\n";
			text += "   #L4##v"+低级神圣装备[1]+"##b#e雷昂套装#k#n升级#r#e鲨齿套装#k#n[#g海盗#k]#v"+高级革命装备[1]+"##l\r\n";
			text += "   #L5##v"+低级革命装备[1]+"##b#e鲨齿套装#k#n升级#r#e鲁塔比斯#k#n[#g海盗#k]#v"+高级宝藏装备[1]+"##l\r\n";
			text += "\r\n ";
		cm.sendSimple(text);
		} else if (status == 1) {
			 if (selection == 1) {
