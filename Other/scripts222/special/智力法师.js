...
var 选择的分解装备; 
var 获得分解材料数量 = 0;
var 低级赛手装备 = Array(1003198,1052334,1072503,1082306,1032031,1152194);
var 高级女皇装备 = Array(1002777,1052156,1072356,1082235,1372044,1382057);

var 低级女皇装备 = Array(1002777,1052156,1072356,1082235,1372044);
var 高级女神装备 = Array(1003771,1052581,1072787,1082507,1102515);

var 低级女神装备 = Array(1003771,1052581,1072787,1082507,1102515,1372044,1382057);
var 高级神圣装备 = Array(1003155,1052300,1072472,1082286,1102263,1372080,1382102);

var 低级神圣装备 = Array(1003155,1052300,1072472,1082286,1102263,1372080,1382102,1132095);
var 高级革命装备 = Array(1003173,1052315,1072486,1082296,1102276,1372084,1382104,1152110);

var 低级革命装备 = Array(1003173,1052315,1072486,1082286,1102263,1132095,1372084,1382104);
var 高级宝藏装备 = Array(1003798,1042255,1062166,1082334,1102477,1132170,1372232,1382269);
var 低级全系列 = Array(1003198,1052334,1072503,1082306,1132095,1032031,1152194);
function start() {
    status = -1;
    action(1, 0, 0);
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "   #L1##v"+低级赛手装备[1]+"##b#e神秘漫步#k#n升级#r#e永恒套装#k#n[#g魔法师#k]#v"+高级女皇装备[1]+"##l\r\n";
			text += "   #L2##v"+低级女皇装备[1]+"##b#e永恒套装#k#n升级#r#e皇家记忆#k#n[#g魔法师#k]#v"+高级女神装备[1]+"##l\r\n";
			text += "   #L3##v"+低级女神装备[1]+"##b#e皇家记忆#k#n升级#r#e雷昂套装#k#n[#g魔法师#k]#v"+高级神圣装备[1]+"##l\r\n";
			text += "   #L4##v"+低级神圣装备[1]+"##b#e雷昂套装#k#n升级#r#e龙尾套装#k#n[#g魔法师#k]#v"+高级革命装备[1]+"##l\r\n";
			text += "   #L5##v"+低级革命装备[1]+"##b#e龙尾套装#k#n升级#r#e鲁塔比斯#k#n[#g魔法师#k]#v"+高级宝藏装备[1]+"##l\r\n";
			text += "\r\n ";
		cm.sendSimple(text);
		} else if (status == 1) {
			 if (selection == 1) {
