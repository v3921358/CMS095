...
var itemArr = [ //快乐转蛋卷
    [15000000, 4110000, 1],
	[130000000, 4110000, 10],
    [2100000000, 4110000, 50]
      
]
var equipArr = [ //高级快乐百宝卷
    [15000000, 5220010, 1],
	[130000000, 5220010, 10],
    [2100000000, 5220010, 50]
]
var ConsumArr = [// 快乐百宝卷
    [15000000, 5220000, 5],
    [130000000, 5220000, 55],
    [2100000000, 5220000, 30]
];
var SettingsArr = [// 新手转蛋卷
    [15000000, 5451001, 10],
	[130000000, 5451001, 110],
    [2100000000, 5451001, 600]
];
var status = 0;
var rn = "\r\n\r\n"; // 换行
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status === 0) {
            ...
            var add = "请选择你取走的物品, 当前金币:#b" + cm.getPlayer().getMeso() + "#l" + rn;
            ...
            if (selType == 0) {
                ...
                if (cm.getPlayer().getMeso() >= selArr[selection][0]) {
                    txt2 = "#d确定使用【" + selArr[selection][0] + "】金币取走#v" + selArr[selection][1] + "##z" + selArr[selection][1] + "# X " + selArr[selection][2] + " 个吗？#l";
                } else {
                    cm.sendOk("你投了个假币~~~");
                    cm.dispose();
                    return;
