...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		var txt = "";
		txt += "   \t  " + 心2 + "   " + 心2 + "  #r#e < 双倍经验礼包 > #k#n  " + 心2 + "   " + 心2 + "\r\n\r\n";
		txt += "  #e以下是#b双倍经验礼包#k奖品，#r每日#k限购#r一次#k，仅售#r12#k，是否领取？#k\r\n\r\n"
		txt += ""+奖励+"\r\n"
		txt += "\t"+红色箭头+" #v5200002# 2880 点券 #r多赠20%#k #v5200002#\r\n\r\n"; 
		txt += "\t"+红色箭头+" #v2450019# 2 个 #z2450019# #v2450019#\r\n\r\n"; 
		txt += "\t"+红色箭头+" #v2028048# 5 个 #z2028048# #v2028048#\r\n\r\n"; 
		cm.sendYesNo(txt);
	} else if (status == 1) {
