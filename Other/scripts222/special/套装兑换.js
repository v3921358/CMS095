...
var 三级链接;
var 分解材料 = 4000313;
var 所需数量 = Array(0,20,3,1);//10为升级所需数量 3为兑换所需数量 1为分解获得数量
var 选择的赛手装备;
var 选择的赛手装备位置;
var 选择的女皇装备;
var 选择的女皇装备位置;
...
var 选择的分解装备; 
var 获得分解材料数量 = 0;
var 低级赛手装备 = Array(1003922,1052638,1072844,1082536);
var 高级女皇装备 = Array(1003159,1052304,1072476,1082290);

var 低级女皇装备 = Array(1003159,1052304,1072476,1082290,1492082,1482081,1472119,1462095,1452108,1432082,1402092,1372081,1332127);
var 高级女神装备 = Array(1003160,1052305,1072477,1082291,1492083,1482082,1472120,1462096,1452109,1432083,1402093,1372082,1332128);

var 低级女神装备 = Array(1003160,1052305,1072477,1082291,1492083);
var 高级神圣装备 = Array(1004172,1052758,1012471,1102691,1122280);

var 低级神圣装备 = Array(1004172,1052758,1012471,1102691,1122280,1382101);
var 高级革命装备 = Array(1003946,1052647,1072853,1102612,1082540,1132242);

var 低级革命装备 = Array(1003946,1052647,1072853,1102612,1082540,1132242,1003946,1052647,1072853,1102612,1082540,1132242);
var 高级宝藏装备 = Array(1004492,1052929,1073057,1102828,1082647,1132287,1098008,1099014,1122306,1142833,1152187,1012524);
var 低级全系列 = Array(1003922,1052638,1072844,1082536,1492082,1482081,1472119,1462095,1452108,1432082,1402092,1372081,1332127,1492083,1482082,1472120,1462096,1452109,1432083,1402093,1372082,1332128,1382101);
function start() {
    status = -1;
    action(1, 0, 0);
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += " #L1##v"+低级赛手装备[1]+"##b#e赛手套装#k#n升级#r#e女皇套装#k#n[#g全系#k]#v"+高级女皇装备[1]+"##l\r\n";
			text += " #L2##v"+低级女皇装备[1]+"##b#e女皇套装#k#n升级#r#e女神套装#k#n[#g全系#k]#v"+高级女神装备[1]+"##l\r\n";
			text += " #L3##v"+低级女神装备[1]+"##b#e女神套装#k#n升级#r#e神圣套装#k#n[#g全系#k]#v"+高级神圣装备[1]+"##l\r\n";
			text += " #L4##v"+低级神圣装备[1]+"##b#e神圣套装#k#n升级#r#e革命套装#k#n[#g全系#k]#v"+高级革命装备[1]+"##l\r\n";
			text += " #L5##v"+低级革命装备[1]+"##b#e革命套装#k#n升级#r#e宝藏套装#k#n[#g全系#k]#v"+高级宝藏装备[1]+"##l\r\n";
			text += "\r\n ";
		cm.sendSimple(text);
		} else if (status == 1) {
			 if (selection == 1) {
