...
function setup(eim, leaderid) {
    ...
    var mob1 = em.getMonster(8910000);
    eim.registerMonster(mob1);
    map.spawnMonsterOnGroundBelow(mob1, new java.awt.Point(-176, 455));
...
function playerEntry(eim, player) {
    ...
    //var map = eim.getMapFactory().getMap(105200510);
    //player.changeMap(map, map.getPortal(0));
}
