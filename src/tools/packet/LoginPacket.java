...
public class LoginPacket {
    ...
    public static final byte[] getHello(final short mapleVersion, final byte[] sendIv, final byte[] recvIv, final MapleClient c) {
    ...
    public static final byte[] getAuthSuccessRequest(final MapleClient client) {
        ...
        mplew.writeInt(client.getAccID());
        mplew.write(client.getGender());
        mplew.write(/*client.isGm() ? 1 : 0*/0); // Admin byte - Find, Trade, etc.
        mplew.write(/*client.isGm() ? 1 : 0*/0); // Admin byte - Commands
        mplew.writeMapleAsciiString(client.getAccountName());
        mplew.writeLong(0L);
