...
public class FilePrinter {
    ...
    public static final String ChaosHT = "ChaosHT.txt";
    public static final String Chinese_Lion = "Chinese_Lion.txt";
    public static final String PinkbeanLog = "PinkbeanLog.txt";
    public static final String ZakumLog = "ZakumLog.txt";
    public static final String PapLog = "PapLog.txt";
    public static final String EBPQLog = "EBPQLog.txt";
    public static final String NBPQLog = "NBPQLog.txt";
    public static final String HBPQLog = "HBPQLog.txt";
    public static final String HEPQLog = "HEPQLog.txt";
    public static final String TokyoLog = "TokyoLog.txt";
    public static final String JapanBOSSLog = "JapanBOSSLog.txt";
    public static final String MalaysiaBOSSLog = "MalaysiaBOSSLog.txt";
    public static final String Dojodare = "Dojodare.txt";
