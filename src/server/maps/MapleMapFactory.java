...
public class MapleMapFactory {
    ...
    public final MapleMap getMap(final int mapid, final boolean respawns, final boolean npcs, final boolean reactors) {
        ...
        if (map == null) {
            ...
            try {
                ...
                for (MapleData life : mapData.getChildByPath("life")) {
                    ...
                    if ((npcs || !type.equals("n")) && !limited.equals("Stage0")) { //alien pq stuff
                        ...
                        if (myLife instanceof MapleMonster && !GameConstants.isNoSpawn(mapid)) {
                            final MapleMonster mob = (MapleMonster) myLife;//怪物加倍
                ...
                map.setCreateMobInterval((short) MapleDataTool.getInt(mapData.getChildByPath("info/createMobInterval"), 5000));
                ...
                map.setForcedReturnMap(mapid == 551030200 ? 551030100 : mapid == 280030001 ? 211042401 : mapid == 280030000 ? 211042400 : GameConstants.isHorntailMap(mapid) ? 240050400 : mapid == 0 ? 999999999 : MapleDataTool.getInt(mapData.getChildByPath("info/forcedReturn"), 999999999));
    ...
    private final MapleReactor loadReactor(final MapleData reactor, final String id, final byte FacingDirection) {
        ...
        myReactor.setDelay(myReactor.getReactorId() == 2202003 ? (-1 * 1000) : (MapleDataTool.getInt(reactor.getChildByPath("reactorTime")) * 1000));
    ...
    private void addAreaBossSpawn(final MapleMap map) {
        ...
        switch (map.getId()) {
            ...
            case 251010101: // Bamboo Warrior
                mobtime = 2700;
                monsterid = 6090002;
                msg = "竹林裏出現了壹个來歷不明的青竹武士，只要打碎小竹片，就可讓青竹武士大发雷霆而葬失自制力，並將他打倒。";
            ...
            case 103040430:
                ...
                monsterid = 4300013;
                msg = "搖滾的精神出現了。";
                pos1 = new Point(240, 88);
                pos2 = new Point(240, 88);
                pos3 = new Point(240, 88);
                break;
