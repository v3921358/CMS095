        ...
        switch (skillId) {
            ...
            case 145:
                ...
                if (monster != null && monster.getMap() != null) {
                    ...
                    monster.getMap().broadcastMessage(MobPacket.spawnMonster(monster, -1, 0), oldPos);
                    monster.getMap().broadcastMessage(MobPacket.spawnMonster(monster, -1, 0), monster.getTruePosition());
    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill) {
	    ...
	    case 115:
            ...
            case 143: // Weapon Reflect
                ...
                monster.getMap().broadcastMessage(MaplePacketCreator.spouseMessage("[系統提示] 注意 " + monster.getStats().getName() + " 开启了物理反射状态。", true));
                break;
            case 144: // Magic Reflect
                ...
                monster.getMap().broadcastMessage(MaplePacketCreator.spouseMessage("[系統提示] 注意 " + monster.getStats().getName() + " 开启了魔法反射状态。", true));
                break;
            case 145: // Weapon / Magic reflect
                ...
                monster.getMap().broadcastMessage(MaplePacketCreator.spouseMessage("[系統提示] 注意 " + monster.getStats().getName() + " 开启了物理和魔法反射状态。", true));
                break;
            case 200:
                if (monster == null) {
                    return;
