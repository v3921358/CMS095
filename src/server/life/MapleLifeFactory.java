...
public class MapleLifeFactory {
    ...
    public static MapleMonsterStats getMonsterStats(int mid) {
        ...
        if (stats == null) {
            ...
            //stats.setHp(GameConstants.getPartyPlayHP(mid) > 0 ? (long) GameConstants.getPartyPlayHP(mid) : GameConstants.isBoss(mid) ? ((long) MapleDataTool.getIntConvert("maxHP", monsterInfoData) * 2) : (long) MapleDataTool.getIntConvert("maxHP", monsterInfoData));
            ...
            stats.setExp(mid == 9300027 ? 0 : (GameConstants.getPartyPlayEXP(mid) > 0 ? GameConstants.getPartyPlayEXP(mid) : mid == 8300007 ? MapleDataTool.getIntConvert("exp", monsterInfoData, 0) * 2 : MapleDataTool.getIntConvert("exp", monsterInfoData, 0)));
            ...
            stats.setExplosiveReward(stats.isBoss() ? true : (MapleDataTool.getIntConvert("explosiveReward", monsterInfoData, 0) > 0));
            ...
            stats.setFfaLoot(stats.isBoss() ? true : MapleDataTool.getIntConvert("publicReward", monsterInfoData, 0) > 0);
            ...
            if (stats.isBoss() || isDmgSponge(mid)) {
                ...
                } else if (mid >= 9800000 && mid <= 9800124) {
                    stats.setTagColor(0);
                    stats.setTagBgColor(0);
                } else {
    ...
    public static MapleNPC getNPC(final int nid) {
        ...
        //if (nid == 9330040 || nid == 9330112 || nid == 9330113 || nid == 9330114 || nid == 9330115 || nid == 9330116 || nid == 9330118 || nid == 9330119 || nid == 9330136) {
        //    return null;
        //}
