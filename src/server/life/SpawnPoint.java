...
public class SpawnPoint extends Spawns {
    ...
    public final boolean shouldSpawn(long time) {
        ...
        //if (((mobTime != 0 || !monster.getMobile()) && spawnedMonsters.get() > 0) || spawnedMonsters.get() > 1 && !ServerConstants.MoonlightRevamp || spawnedMonsters.get() > ServerConstants.monsterSpawn && ServerConstants.MoonlightRevamp) {
            return false;
        }
