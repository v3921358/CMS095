...
public abstract class Timer {
    ...
    public void start() {
        ...
        ses = new ScheduledThreadPoolExecutor(10, new RejectedThreadFactory());
        ses.setKeepAliveTime(10, TimeUnit.MINUTES);
        ses.allowCoreThreadTimeOut(true);
        ses.setCorePoolSize(10);
        ses.setMaximumPoolSize(16);
    ...
    private static class LoggingSaveRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                FileoutputUtil.logToFile("logs/Timer.txt", t.toString() + "\r\n");
            }
        }
    }
    ...
    private class RejectedThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable r) {
            ...
            t.setName(tname + "-Worker-" + threadNumber.getAndIncrement() + "-" + threadNumber2.getAndIncrement());
            return t;
        }
    }
}
    ...
    private static class LoggingSaveRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                FileoutputUtil.outputFileError("logs/Timer.txt", t);
            }
        }
    }
