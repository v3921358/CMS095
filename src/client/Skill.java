...
public class Skill {
    ...
    public static final Skill loadFromData(final int id, final MapleData data, final MapleData delayData) {
        ...
        if (skillType == 2) {
            ...
            switch (id) {
                ...
                case 32111012: //blue aura, v121 msea update?
                case 32110000:
    ...
    public boolean isFourthJob() {
        ...
        if ((getMaxLevel() <= 15 && !invisible && getMasterLevel() <= 0) || id == 3220010 || id == 3120011 || id == 33120010 || id == 5321006 || id == 21120011 || id == 22181004 || id == 4340010) {
            return false;
        }
    ...
    public boolean isSpecialSkill() {
        int jobId = id / 10000;
        return jobId == 900 || jobId == 800 || jobId == 7000 || jobId == 7100 || jobId == 8000 || jobId == 9000 || jobId == 9100 || jobId == 9200 || jobId == 9201 || jobId == 9202 || jobId == 9203 || jobId == 9204;
    }
}
