...
public class SkillFactory {
    ...
    private final static MapleData stringSkills = MapleDataProviderFactory.getDataProvider(new File((System.getProperty("wzpath") != null ? System.getProperty("wzpath") : "") + "wz/String.wz")).getData("Skill.img");
...
//                  }
    ...
    public static final String getNamea(final int id) {
        String strId = Integer.toString(id);
        strId = StringUtil.getLeftPaddedStr(strId, '0', 7);
