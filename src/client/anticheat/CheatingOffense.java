...
public enum CheatingOffense {
    ...
    快速攻击((byte)10, 60000, 50, (byte)2),   // 60秒內 触发50次 DC
    控怪((byte)1, 60000, -1, (byte)1),
    无延迟攻击((byte)5, 10000, 20, (byte)3),  // 10秒內 触发20次 自訂封锁
    MOB_VAC_X((byte) 1, 10000, 20, (byte) 3), // 10秒內 触发20次 自訂封锁
    吸怪((byte) 1, 7000, 5, (byte) 3),// 7秒內 触发5次 自訂封锁
    ATTACK_FARAWAY_MONSTER_BAN((byte) 3, 60000, 60, (byte) 3),
    攻击怪物數量异常((byte)1, 600000, 7, (byte)3),// 600秒內 触发7次 自訂封锁
    技能攻击次數异常((byte)1, 600000, 7, (byte)3),// 600秒內 触发7次 自訂封锁
    ITEMVAC_CLIENT((byte) 3, 10000, 100),
    ITEMVAC_SERVER((byte) 2, 10000, 50, (byte) 2),
    召喚獸全圖打((byte)5, 180000, 20, (byte)2),// 180秒內觸二十次即DC
    召喚獸攻击怪物數量异常((byte)1, 600000, 7, (byte)3),// 600秒內 触发7次 自訂封锁
