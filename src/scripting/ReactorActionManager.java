...
public class ReactorActionManager extends AbstractPlayerInteraction {
    ...
    public void dropItems(boolean meso, int mesoChance, int minMeso, int maxMeso, int minItems) {
        ...
        for (final ReactorDropEntry d : items) {
            if (d.itemId == 0) {
                ...
                mesoDrop = Randomizer.nextInt(range) + minMeso * ChannelServer.getInstance(getClient().getChannel()).getMesoRate() / 10;
    ...
    public void doHarvest() { //TODO LEGEND
        ...
        final String pName = (getReactor().getReactorId() < 200000 ? "採藥" : "採礦");
