...
public class EventInstanceManager {
    ...
    public void registerPlayer(MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.logToFile(FileoutputUtil.ScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : playerEntry:\n" + ex);
    ...
    public void changedMap(final MapleCharacter chr, final int mapid) {
        ...
        try {
            ...
            FileoutputUtil.logToFile(FileoutputUtil.ScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : changedMap:\n" + ex);
        ...
        eventTimer = EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    FileoutputUtil.logToFile(FileoutputUtil.ScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : scheduledTimeout:\n" + ex);
    ...
    public void unregisterMonster(MapleMonster mob) {
        ...
        if (mobs.size() == 0) {
            try {
                ...
                FileoutputUtil.logToFile(FileoutputUtil.ScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : allMonstersDead:\n" + ex);
    ...
    public void playerKilled(MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.logToFile(FileoutputUtil.ScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : playerDead:\n" + ex);
    ...
    public boolean revivePlayer(MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.logToFile(FileoutputUtil.ScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : playerRevive:\n" + ex);
    ...
    public void monsterKilled(final MapleCharacter chr, final MapleMonster mob) {
        ...
        try {
            ...
            FileoutputUtil.logToFile(FileoutputUtil.ScriptEx_Log, "Event name" + (em == null ? "null" : em.getName()) + ", Instance name : " + name + ", method Name : monsterValue:\n" + ex);
...
//        if (chr.isGM()) {
//            chr.dropMessage("[Npc_Debug]" + text);
//        }
